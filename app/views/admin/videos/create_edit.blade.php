...
@section('content')
	...
	{{-- Edit Blog Form --}}
	<form class="form-horizontal" method="post" action="@if (isset($video)){{ URL::to('admin/videos/' . $video->id . '/edit') }}@endif" autocomplete="off">
		<!-- CSRF Token -->
			...
			<div class="tab-pane active" id="tab-general">
				...
				<!-- Video link -->
                                <div class="form-group {{{ $errors->has('link') ? 'error' : '' }}}">
                                    <div class="col-md-12">
                                        <label class="control-label" for="link">Ссылка на видео</label>
