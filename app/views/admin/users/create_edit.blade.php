		...
		<div class="tab-content">
			...
			<div class="tab-pane active" id="tab-general">
				...
				<div class="form-group {{{ $errors->has('password_confirmation') ? 'error' : '' }}}">
					<label class="col-md-2 control-label" for="password_confirmation">Повторите пароль</label>
					<div class="col-md-10">
				...
				<div class="form-group {{{ $errors->has('roles') ? 'error' : '' }}}">
	                <label class="col-md-2 control-label" for="roles">Роли</label>
	                <div class="col-md-6">
						...
						<span class="help-block">
							Выберите группу для пользователя. Пользователь получает права группы в которую его назначили
						</span>
	            	</div>
				</div>
				<!-- ./ groups -->
